...
public:
    ...
    void initMPU6050()
    {
        ...
        writeByte(MPU6050_ADDRESS, GYRO_CONFIG, c | (uint8_t)GFSSEL << 3); // Set full scale range for the gyro
        ...
        writeByte(MPU6050_ADDRESS, ACCEL_CONFIG, c | (uint8_t)AFSSEL << 3); // Set full scale range for the accelerometer
